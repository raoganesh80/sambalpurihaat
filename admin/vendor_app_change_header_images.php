...
<!-- ============================================ -->
<?php
    $active_page_name = 'vendor_app_change_header_images';
...
if($_SERVER['REQUEST_METHOD']=="POST" && !empty($_FILES["fileToUpload"]["name"])){
  ...
  if(isset($_POST['vendor_banner1']))
  {
    $_FILES["fileToUpload"]["name"]='vendor_banner1.jpg';
  }
  if(isset($_POST['vendor_banner2'])){
    $_FILES["fileToUpload"]["name"]='vendor_banner2.jpg';
  }
  if(isset($_POST['vendor_banner3'])){
    $_FILES["fileToUpload"]["name"]='vendor_banner3.jpg';
  }
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="container row align-items-center mb-4">
        <img id="profile-img-tag1" src="images/banners/vendor_banner1.jpg" class="img-lg mr-5">
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
          Select image to upload(size 750x400):
          <input type="file" name="fileToUpload" id="fileToUpload1">
          <input type="submit" value="Upload Image" name="vendor_banner1">
        </form>
      </div>
      <div class="container row align-items-center mb-4">
        <img id="profile-img-tag2"  src="images/banners/vendor_banner2.jpg" class="img-lg mr-5">
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
          Select image to upload(size 750x400):
          <input type="file" name="fileToUpload" id="fileToUpload2">
          <input type="submit" value="Upload Image" name="vendor_banner2">
        </form>
      </div>
      <div class="container row align-items-center mb-4">
        <img id="profile-img-tag3"  src="images/banners/vendor_banner3.jpg" class="img-lg mr-5">
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
          Select image to upload(size 750x400):
          <input type="file" name="fileToUpload" id="fileToUpload3">
          <input type="submit" value="Upload Image" name="vendor_banner3">
        </form>
      </div>
    </div>
  </div>
